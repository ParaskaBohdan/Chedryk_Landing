  ...
  const highlights = [
    {
      ...
      desc: 'Повний супровід: подача заяви, проєктна документація, ТУ, збільшення дозволеної вхідної потужності будинку або об\'єкта.',
      badge: '100% Бюрократія на нас'
    },
    {
      icon: Leaf,
      title: 'Підключення Зеленого Тарифу (Закарпаття)',
      desc: 'Консультації, збір документів, встановлення двонаправленого лічильника та юридичний супровід до виплат за електроенергію для станцій у Закарпатській області.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-3 sm:space-y-4">
          ...
          <p className={`text-sm sm:text-lg font-medium ${isDark ? 'text-slate-300' : 'text-slate-700'}`}>
            Беремо на себе найскладніші етапи — від юридичного оформлення документів до вибору інверторів Deye на Закарпатті, Франківщині та Львівщині.
          </p>
        </div>
