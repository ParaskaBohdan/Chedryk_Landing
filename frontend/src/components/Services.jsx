...
export default function Services({ onSelectService, theme }) {
  ...
  const services = [
    ...
    },
    {
      ...
      details: 'Інженери Nova Energy беруть на себе весь бюрократичний процес. Вам не потрібно самостійно стояти в чергах Обленерго — ми підготуємо повний пакет документів під ключ.'
    },
    {
      id: 'electrical_grids',
      ...
      details: 'Команда Nova Energy виконує електромонтажні роботи будь-якої складності. Гарантуємо пожежну безпеку, правильне балансування фаз та сучасне маркування кожного автомата у вашому щитку.'
    }
  ];
