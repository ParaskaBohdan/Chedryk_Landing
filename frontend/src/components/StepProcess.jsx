  ...
  const steps = [
    {
      ...
      icon: PhoneCall,
      phase: 'Виїзд та замір',
      desc: 'Первинна розмова, аналіз потреб будинку чи бізнесу. Виїзд інженера Nova Energy для огляду покрівлі, електрощита та замір по Закарпаттю й Франківщині.'
    },
    {
      step: '02',
      title: 'Проєктування & Дозволи Обленерго',
      icon: FileText,
      phase: 'Проєкт та дозволи',
    ...
    },
    {
      ...
      icon: Headphones,
      phase: 'Підключення та сервіс',
      desc: 'Встановлення двонаправленого лічильника, підключення Зеленого Тарифу (для Закарпаття) або Net Billing, інструктаж та технічний супровід.'
    }
  ];
