      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-4">
          ...
          <p className={`text-sm sm:text-lg ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
            Повний комплекс інженерних робіт у Закарпатській, Івано-Франківській та Львівській областях: будівництво СЕС, резервне живлення, документація та монтаж під ключ.
          </p>
